...
Next step do only from virtualenv or pyvenv
	...
	1) run requirements.txt file by command "pip install -r requirements.txt" to set all the required libraries
	2) if you want start server need run command "python3 search_serv.py"
